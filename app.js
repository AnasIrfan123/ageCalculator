...
function ageCalculate() {
    ...
    leapChecker(currentYear);          // call the leap year function
    ...
    displayResult(birthDate,birthMonth,birthYear);         // call the display the out function
}
